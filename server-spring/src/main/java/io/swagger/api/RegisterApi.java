...
public interface RegisterApi {
    ...
    @ApiOperation(value = "Register new user.", nickname = "registerPost", notes = "", response = Integer.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Integer> registerPost(@ApiParam(value = "User object needed to be added into system." ,required=true )  @Valid @RequestBody Register body
);
